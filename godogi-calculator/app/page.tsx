              ...
              {!editingShop ? (
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <button onClick={() => { setShopDraft(shopInfo); setEditingShop(true) }}
                    style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(200,216,228,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginLeft: 10, padding: 4 }}>
