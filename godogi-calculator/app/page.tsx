...
export default function HomePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0F1923', color: 'white', fontFamily: "'Noto Sans KR', sans-serif", display: 'flex' }}>
      ...
      {/* 메인 콘텐츠 */}
      <main style={{ flex: 1, marginLeft: (user || isGuest) ? 240 : 0, transition: 'margin-left 0.25s' }} className="dashboard-main">
      <SetupModal
        show={showSetup}
        step={setupStep}
        setStep={setSetupStep}
      ...
      {showReceiptLoginModal && (
        <>
          ...
          <div style={{
            ...
            maxWidth: 500, boxSizing: 'border-box',
      ...
      {(() => {
        ...
        return (
      <>
      <main className="home-main" style={{ maxWidth: 680, margin: '0 auto', padding: '24px 12px 100px', display: 'flex', flexDirection: 'column' }}>
